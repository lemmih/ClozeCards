      ...
      <Router>
        <div>
          <Menu attached="top" inverted={true} color="blue" size="huge" stackable={true}>
            ...
            <Menu.Item as={Link} to={"/top-decks/"}>Top Decks</Menu.Item>
            <Menu.Item as={Link} to={"/recent-decks/"}>Recent Decks</Menu.Item>
            ...
            <Menu.Menu position="right">
              ...
              ? <Dropdown item text={user.email}>
                  <Dropdown.Menu>
                    <Dropdown.Item as={Link} to={"/new-deck/"}>New Deck</Dropdown.Item>
                    <Dropdown.Item onClick={this.logout} as={Link} to={"/"}>Logout</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
          ...
          <Switch>
            ...
            <Route path="/top-decks/" exact={true} render={() => <BrowseDecks order="ByLikes"/>}/>
            <Route path="/recent-decks/" exact={true} render={() => <BrowseDecks order="ByDate"/>}/>
            <Route path="/trending-decks/" exact={true} render={() => <BrowseDecks order="ByTrending"/>}/>
            <Route path="/new-deck/" exact={true} render={() => <NewDeck/>}/>
            <Route path="/decks/:slug" exact={true} render={this.matchViewDeck}/>
            <Route path="/decks/:slug/notes" exact={true} render={this.matchViewNotes}/>
            <Route path="/decks/:slug/study" exact={true} render={this.matchStudy}/>
